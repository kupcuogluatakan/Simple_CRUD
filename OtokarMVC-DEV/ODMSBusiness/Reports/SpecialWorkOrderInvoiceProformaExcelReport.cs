...
{
    class SpecialWorkOrderInvoiceProformaExcelReport : ReportBase, IReport
    {
        public byte[] FetchBytes(params object[] parameters)
        {
            return Client.SpecialWorkOrderInvoiceProformaExcelReport(Credentials, (string)parameters[0], (long)parameters[1]);
        }
