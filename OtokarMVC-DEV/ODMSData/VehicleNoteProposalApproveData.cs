...
namespace ODMSData
{
    public class VehicleNoteProposalApproveData : DataAccessBase
    {
        public List<VehicleNoteProposalApproveListModel> ListVehicleNoteProposalApprove(UserInfo user, VehicleNoteProposalApproveListModel filter, out int totalCnt)
        {
            var retVal = new List<VehicleNoteProposalApproveListModel>();
            totalCnt = 0;
            ...
            try
            {
                ...
                using (var reader = cmd.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        var vehicleNoteProposalApproveListModel = new VehicleNoteProposalApproveListModel
                        {
                        ...
                        retVal.Add(vehicleNoteProposalApproveListModel);
                    }
                    reader.Close();
                }
        ...
        public List<SelectListItem> ListVehicleNoteProposalApproveAsSelectListItem(UserInfo user)
        {
            ...
            try
            {
                ...
                db.AddInParameter(cmd, "IS_APPROVE_DATE", DbType.Int32, false);
                db.AddInParameter(cmd, "ID_VEHICLE_NOTE_PROPOSAL", DbType.Int32, MakeDbNull(0));
                db.AddInParameter(cmd, "ID_VEHICLE", DbType.Int32, MakeDbNull(0));
                ...
                using (var reader = cmd.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        {
                            Value = reader["ID_VEHICLE_NOTE_PROPOSAL"].GetValue<string>(),
        ...
        public void GetVehicleNoteProposalApprove(UserInfo user, VehicleNoteProposalApproveModel filter)
        {
        ...
        public void DeleteVehicleNoteProposalApprove(VehicleNoteProposalApproveModel model)
        {
            try
            {
                CreateDatabase();
                var cmd = db.GetStoredProcCommand("P_DELETE_VEHICLE_NOTE_PROPOSAL");
                db.AddInParameter(cmd, "ID_VEHICLE_NOTE_PROPOSAL", DbType.Int32, MakeDbNull(model.VehicleNotesId));
        ...
        public void ApproveVehicleNoteProposal(UserInfo user, VehicleNoteProposalApproveModel model)
        {
            try
            {
                CreateDatabase();
                var cmd = db.GetStoredProcCommand("P_APPROVE_VEHICLE_NOTE_PROPOSAL");
                db.AddInParameter(cmd, "ID_VEHICLE_NOTE_PROPOSAL", DbType.Int32, MakeDbNull(model.VehicleNotesId));
                ...
                CreateConnection(cmd);
                cmd.ExecuteNonQuery();
                model.VehicleNotesId = db.GetParameterValue(cmd, "ID_VEHICLE_NOTE_PROPOSAL").GetValue<int>();
