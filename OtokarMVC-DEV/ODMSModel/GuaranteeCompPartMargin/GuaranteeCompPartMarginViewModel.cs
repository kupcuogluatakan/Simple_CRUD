...
{
    [Validator(typeof(GuaranteeCompPartMarginViewModelValidator))]
    public class GuaranteeCompPartMarginViewModel : ModelBase
    {
        public GuaranteeCompPartMarginViewModel()
        {
        }
