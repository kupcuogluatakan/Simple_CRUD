...
{
    public class GuaranteeCompPartMarginListModel : BaseListWithPagingModel
    {
        public GuaranteeCompPartMarginListModel()
        {

        }

        public GuaranteeCompPartMarginListModel([DataSourceRequest] DataSourceRequest request)
            : base(request)
        {
            var dMapper = new Dictionary<string, string>
                 {
                     {"IdGrntPartMrgn","ID_GRNT_PART_MRGN"},
        ...
        /// 	</description>
        /// </summary>
        public int IdGrntPartMrgn { get; set; }
