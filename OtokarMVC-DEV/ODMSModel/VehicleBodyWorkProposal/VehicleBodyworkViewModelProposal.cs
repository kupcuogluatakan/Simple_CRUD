...
{
    [Validator(typeof(VehicleBodyworkViewModelValidatorProposal))]
    public class VehicleBodyworkViewModelProposal : ModelBase
    {
        public VehicleBodyworkViewModelProposal()
        {
        }
