...
{
    public class VehicleNoteProposalApproveListModel : BaseListWithPagingModel
    {
        public VehicleNoteProposalApproveListModel([DataSourceRequest] DataSourceRequest request)
           : base(request)
        {
        ...
        public VehicleNoteProposalApproveListModel()
        {
