...
{
    [Validator(typeof(SparePartSaleViewModelValidator))]
    public class SparePartSaleViewModel : ModelBase
    {
        ...
        [Display(Name = "SparePartSale_Display_VatExclude", ResourceType = typeof(MessageResource))]
