...
namespace ODMSService.Jobs
{
    ...
    internal class WorkOrderDetailReportHourControlJob : JobBase, IJob
    {
        public Task Execute(IJobExecutionContext context)
        {
            var serviceCallSchedule = serviceCallScheduleBL.Get("WORK_ORDER_HOUR_CONTROL").Model;
            ...
            try
            {
                ...
                LoggerFactory.Logger.AddLog(LoggerType.File, ServiceType.WORK_ORDER_HOUR_CONTROL, "CheckWorkOrderHourData metodu çağırılıyor");

                string errorMessage = ReportBl.CheckWorkOrderHourData().Model;

                LoggerFactory.Logger.AddLog(LoggerType.File, ServiceType.WORK_ORDER_HOUR_CONTROL, "CheckWorkOrderHourData metodu bitti");
            ...
            {
                LoggerFactory.Logger.AddLog(LoggerType.File, ServiceType.WORK_ORDER_HOUR_CONTROL, string.Format("Hata : {0}", ex.Message));
