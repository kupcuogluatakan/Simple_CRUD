...
{
    public class UnitTestGetAllHandler : UnitTestHandler
    {
        public UnitTestGetAllHandler()
        {
        }
        ...
        public override void Create(UnitTestHandler parent, string businessName, string methodName, string filterNames, bool dmlContains)
        {
            ...
            if (methodName.Contains("List") || (methodName.Contains("Get") && methodName.Contains("List")))
            {
                ...
                AddTwoTab();
                Builder.Append(string.Format("public void {0}_{1}_GetAll()", businessName, methodName));
                AddTwoTab();
                Builder.Append("{");
                ...
                if (filterNames.Contains("UserInfo") && filterNames.Contains("totalCnt"))
                    Builder.Append(string.Format(" var resultGet = _{0}.{1}(UserManager.UserInfo, filter, out count);", businessName, methodName));
                else if (filterNames.Contains("UserInfo") && filterNames.Contains("totalCount"))
                    Builder.Append(string.Format(" var resultGet = _{0}.{1}(UserManager.UserInfo, filter, out count);", businessName, methodName));

                else if (!filterNames.Contains("UserInfo") && filterNames.Contains("totalCnt"))
                    Builder.Append(string.Format(" var resultGet = _{0}.{1}(filter, out count);", businessName, methodName));
                else if (!filterNames.Contains("UserInfo") && filterNames.Contains("totalCount"))
                    Builder.Append(string.Format(" var resultGet = _{0}.{1}(filter, out count);", businessName, methodName));
                ...
                AddThreeTab();
                AddThreeTab();
                Builder.Append("Assert.IsTrue(resultGet.Total > 0);");
                AddTwoTab();
                Builder.Append("}");
                AddNewLine();
                ...
                if (InsertBuilder.Length > 0 && businessName != "CommonBL" && businessName != "ReportsBL")
                {
                    #region Update 
                    ...
                    Builder.Append("[TestMethod]");
                    AddTwoTab();
                    Builder.Append(UpdateMethodName);
                    AddTwoTab();
                    Builder.Append("{");
                    ...
                    AddThreeTab();
                    Builder.Append("Assert.IsTrue(resultUpdate.Model != null && resultUpdate.IsSuccess);");
                    AddTwoTab();
                    Builder.Append("}");
                    AddNewLine();
                    ...
                    Builder.Append("[TestMethod]");
                    AddTwoTab();
                    Builder.Append(DeleteMethodName);
                    AddTwoTab();
                    Builder.Append("{");
                    ...
                    Builder.Append(DeleteBuilder.ToString());

                    #endregion

                    AddThreeTab();
                    Builder.Append("Assert.IsTrue(resultDelete.IsSuccess);");
                    AddTwoTab();
                    Builder.Append("}");
                    AddNewLine();
