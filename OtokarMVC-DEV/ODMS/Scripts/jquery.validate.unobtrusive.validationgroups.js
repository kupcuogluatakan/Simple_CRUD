$(function () {
    ...
    $("input[type=submit], .causesvalidation").click(function () {
        ...
        $("div.validation-summary, div[data-valmsg-summary=true]", formElement).each(function () {
        ...
        $.each(groupNames.split(' '), function (index, value) {
            if (elementsToValidate === null) {
                elementsToValidate = $("*[data-val-valgroup-name~='" + value + "'],:not([data-val-valgroup-name]),[data-val-valgroup-name='']", formElement);
            } else {
        ...
        $("div.validation-summary, div[data-valmsg-summary=true]", formElement).not(elementsToValidate).each(function () {
