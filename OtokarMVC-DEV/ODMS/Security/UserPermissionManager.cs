...
namespace ODMS.Security
{
    public class UserPermissionManager
    {
        ...
        private void InitializeUserPermissionSessionState()
        {
            ...
            _currentSessionState[ODMSCommon.CommonValues.UserPermissionsSessionKey] = permissionBo.GetUserPermissions(UserManager.UserInfo, UserManager.UserInfo.UserId).Data;
        }

        public void InitializeUserMenuSessionState()
        {
            var menuBo = new ODMSBusiness.MenuBL();
            _currentSessionState[ODMSCommon.CommonValues.UserMenuSessionKey] = menuBo.GetUserMenu(UserManager.UserInfo, UserManager.UserInfo.UserId).Data;
        }
